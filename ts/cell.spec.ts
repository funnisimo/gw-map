...
describe("Cell", () => {
  ...
  test("layerFlags", () => {
    ...
    cell.storeMemory();
    expect(cell.layerFlags()).toEqual(Map.layer.Flags.L_BLOCKS_EVERYTHING);
    expect(cell.layerFlags(true)).toEqual(Map.layer.Flags.L_BLOCKS_EVERYTHING);
  });
  ...
  test("tileFlags", () => {
    ...
    expect(tile.flags.tile).toEqual(
      Map.tile.Flags.T_SPONTANEOUSLY_IGNITES | Map.tile.Flags.T_IS_FLAMMABLE
    );
  ...
  test("hasLayerFlag + hasAllLayerFlags", () => {
    const cell = GW.make.cell("WALL");
    expect(cell.hasLayerFlag(Map.layer.Flags.L_SECRETLY_PASSABLE)).toBeFalsy();
    expect(cell.hasLayerFlag(Map.layer.Flags.L_BLOCKS_MOVE)).toBeTruthy();
    expect(
      cell.hasAllLayerFlags(
        Map.layer.Flags.L_SECRETLY_PASSABLE | Map.layer.Flags.L_BLOCKS_MOVE
      )
    ).toBeFalsy();
    expect(
      cell.hasAllLayerFlags(
  ...
  test("hasTileFlag + hasAllTileFlags", () => {
    ...
    expect(
      cell.hasAllTileFlags(
        Map.tile.Flags.T_SPONTANEOUSLY_IGNITES | Map.tile.Flags.T_AUTO_DESCENT
      )
    ).toBeFalsy();
    expect(
      cell.hasAllTileFlags(
  ...
  test("hasFlag", () => {
    ...
    expect(cell.hasFlag(Map.cell.Flags.HAS_DORMANT_MONSTER, true)).toBeFalsy();
    cell.flags |= Map.cell.Flags.HAS_DORMANT_MONSTER;
    expect(cell.hasFlag(Map.cell.Flags.HAS_DORMANT_MONSTER)).toBeTruthy();
    expect(cell.hasFlag(Map.cell.Flags.HAS_DORMANT_MONSTER, true)).toBeTruthy();
  ...
  test("hasMechFlag", () => {
    ...
    expect(cell.hasMechFlag(Map.cell.MechFlags.IS_IN_LOOP, true)).toBeFalsy();
    cell.mechFlags |= Map.cell.MechFlags.IS_IN_LOOP;
    expect(cell.hasMechFlag(Map.cell.MechFlags.IS_IN_LOOP)).toBeTruthy();
    expect(cell.hasMechFlag(Map.cell.MechFlags.IS_IN_LOOP, true)).toBeTruthy();
